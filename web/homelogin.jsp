		...
		<div id="header-wrapper">
			<div class="5grid">
				<div class="12u-first">
					...
					<header id="header">
						<h1><a href="homelogin.jsp">Hospital</a></h1>
						<nav>
							<a href="" class="current-page-item">Sign In</a>
		...
		<div id="banner-wrapper">
			<div class="5grid">
				<div class="12u-first">
					...
					<div id="banner">
						<form class="form" action = "ReceptionistController">
                                                <input type="password" name ="recepNo" placeholder="userid">
